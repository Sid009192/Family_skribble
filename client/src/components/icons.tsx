/**
 * icons.tsx — small, clean line icons (SVG) for the toolbar.
 *
 * They inherit the text color (`stroke="currentColor"`) so they restyle with
 * CSS automatically. Replacing emoji with these gives a consistent, crisp look.
 */
